...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'gold_inventory.count', 'gold_trade.count', 'owner.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('gold_inventory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'gold_inventory',
          header: 'Gold Inventory',
          accessorKey: 'gold_inventory',
          cell: ({ row: { original: record } }: any) => record?._count?.gold_inventory,
        }
      : null,
    hasAccess('gold_trade', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'gold_trade',
          header: 'Gold Trade',
          accessorKey: 'gold_trade',
          cell: ({ row: { original: record } }: any) => record?._count?.gold_trade,
        }
      : null,
