...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`gold trading application `}</title>

        <meta
          name="description"
          content="Welcome to Gold Trading Application - your one-stop platform for secure and efficient gold trading. Transforming the way you trade gold, one transaction at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1610375461246-83df859d849d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnb2xkfGVufDB8fHx8MTY5NzAwMDYzMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@pokmer?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jingming Pan`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Gold Trading Application - your one-stop platform for secure and efficient gold trading. Transforming the way you trade gold, one transaction at a time.`}
            </Text>
            <Box
